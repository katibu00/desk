...
<html lang="en">
  <head>
    ...
    <title>@yield('pageTitle') - IntelS Help Center</title>
            ...
            <div>
              ...
              <a class="link-fx fw-bold tracking-wide mx-auto" href="#">
                <span class="smini-hidden">
                  ...
                  <span class="fs-4 text-dual">help</span><span class="fs-4 text-primary">Center</span>
                </span>
              </a>
            </div> 
            <div>       
        ...
        <div class="content py-3">
          <div class="row fs-sm">
            <div class="col-sm-6 order-sm-2 py-1 text-center text-sm-end">
              Developed by <a class="fw-semibold" href="#" target="_blank">IntelliSAS Solutions</a>
            </div>
            <div class="col-sm-6 order-sm-1 py-1 text-center text-sm-start">
              <a class="fw-semibold" href="https://1.envato.market/95j" target="_blank">IntelS Help Center 1.6.9</a> &copy; <span data-toggle="year-copy"></span>
            </div>
          </div>
        </div>
      </footer>
